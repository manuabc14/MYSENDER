...
DayGrid.mixin({
	...
	renderSegPopoverContent: function(row, col, segs) {
        ...
        var dayOfWeek = this.getCellDate(row, col).format(view.opt('dayOfWeekPopoverFormat'));
	    var day = this.getCellDate(row, col).format(view.opt('dayPopoverFormat'));
		var content = $(
					...
					if (buttonName == 'title') {
						...
						if (buttonClick) {
							...
							if (overrideText) {
                                ...
                                if (normalIcon === "left-single-arrow") {
                                    innerHtml = "<i class='material-icons'>keyboard_arrow_left</i>";
                                } else if (normalIcon === "right-single-arrow") {
